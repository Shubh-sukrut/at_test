...
import AgencyWebhookTable from "../../components/table/agencywebhook";

const AgencyWebhookdashboard = () => {
  return (
    <>
        ...
        <div className="admin-container ">
          ...
          <div className="mt-3">
            <div className="px-5 py-3 d-flex justify-content-between align-items-center table-container4">
              ...
              <div className="d-flex align-items-center">
                <NavLink to={"/admin/create-agencywebhook"} style={{ color: "black", textDecoration: "None" }}>
                  <div className="text-dark" style={{ cursor: "pointer" }} ></div>
                  <p className="admin-name-choose-sel rounded mb-0 mx-2 py-2 px-4">
                    Create Agency Webhook
                  </p>
                </NavLink>
              </div>
            </div>
...
export default AgencyWebhookdashboard;
