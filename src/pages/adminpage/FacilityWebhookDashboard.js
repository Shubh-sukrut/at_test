...
import FacilityWebhookTable from "../../components/table/facilitywebhook";

const FacilityWebhookdashboard = () => {
  return (
    <>
            ...
            <div className="px-5 py-3 d-flex justify-content-between align-items-center table-container4">
              <div className="d-flex align-items-center">
                ...
                <p className="admin-name-choose-sel rounded mb-0 mx-2 py-2 px-4">
                  Facility Agency Mapping
                </p>
              </div>

              <div className="d-flex align-items-center">
                <NavLink to={"/admin/create-facilitywebhook"} style={{ color: "black", textDecoration: "None" }}>
                  <div className="text-dark" style={{ cursor: "pointer" }} ></div>
                  <p className="admin-name-choose-sel rounded mb-0 mx-2 py-2 px-4">
                    Create Facility Agency Mapping
                  </p>
                </NavLink>
              </div>
            </div>
...
export default FacilityWebhookdashboard;
