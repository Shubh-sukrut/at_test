                ...
                <div className="head-div">
                    ...
                    <div className='filer_boxs'>
                        ...
                        <div className='filer_box '>
                            ...
                            <div className=" border rounded-2 px-2 py-2" style={{
                                height:'80%'
                            }}>
                                 {/* <p>Broadcast Message</p> */}
                                <p>Message:</p>
                                <div className='d-flex align-items-center py-2 px-1  border rounded-2'>
                                    Test message
                                </div>
                                <p>Response:</p>
                                <div className='d-flex align-items-center py-2 px-1 border rounded-2'>
                                            ...
                                            {recepients?.map((contact, index) => {
                                                return (
                                                    <TableRow >
                                                        ...
                                                        <TableCell align="center">{contact?.received}</TableCell>
                                                    </TableRow>
                                                )
                                            })}
                                        </TableBody>
